...
export default React.memo(() =>
    <Card title="Histórico de eventos" button={true} select={true}>
        <StyledHistoricContent className="historic">
            <img className="graphic" src={chart} alt="" />
            <HistoricBase>
                <Paragraph><img src={iconGreen} alt="" />Inspeções realizadas</Paragraph>
                <Paragraph><img src={iconOrange} alt="" />Planos de ação criados</Paragraph>
            </HistoricBase>
